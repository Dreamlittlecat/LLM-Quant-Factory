...
from methods.svd_utils.svdgptq_v2 import SVD_quant
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=int,
        default=2,
        help="Number of rounding iterations to use.",
    )
    parser.add_argument(
        "--disable_gptq",
        action="store_true",
    ...
    parser.add_argument(
        ...
        type=int,
        default=16,
        help="Number of clusters to use for the low-rank approximation.",
    )
    parser.add_argument(
        "--device",
        type=str,
    ...
    device = args.device
    save_title = f"{args.model}_{args.dataset}_rank{args.rank}_percdamp{args.percdamp}_blocksize{args.blocksize}_res_round{args.res_round}_cluster{args.cluster}"
