...
from methods.pbllm_utils.gptq import LowHighGPT
from methods.pbllm_utils.high_quant import HighQuantizer
from methods.pbllm_utils.low_quant import LowQuantizer
...
if __name__ == "__main__":
    ...
    save_title = f"{model_name}_{args.dataset}_{args.low_quant_method}_{args.low_frac}_{args.high_bit}_{args.groupsize}_{args.salient_metric}"
    save_file = "/data/xjh/model_weight/quant/pbllm/" + save_title.replace("/", "_") 
